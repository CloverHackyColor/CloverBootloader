...
#ifndef SMBIOS_TYPE_BIOS_INFORMATION
//
...
//typedef SMBIOS_TABLE_HEADER SMBIOS_STRUCTURE;
///
...
typedef struct {
  ...
  SMBIOS_TABLE_STRING       Vendor; //4
  SMBIOS_TABLE_STRING       BiosVersion;//5
  UINT16                    BiosSegment; //6
  SMBIOS_TABLE_STRING       BiosReleaseDate; //8
  UINT8                     BiosSize; //9
  MISC_BIOS_CHARACTERISTICS BiosCharacteristics; //0x0A
  UINT8                     BIOSCharacteristicsExtensionBytes[2]; //0x12
  UINT8                     SystemBiosMajorRelease; //0x14
  UINT8                     SystemBiosMinorRelease; //0x15
  UINT8                     EmbeddedControllerFirmwareMajorRelease; //0x16
  UINT8                     EmbeddedControllerFirmwareMinorRelease; //0x17
} SMBIOS_TABLE_TYPE0;
...
typedef struct {
  ...
  SMBIOS_TABLE_STRING       BankLocator; //0x11
  UINT8                     MemoryType;   //0x12                  ///< The enumeration value from MEMORY_DEVICE_TYPE.
  MEMORY_DEVICE_TYPE_DETAIL TypeDetail; //0x13
  UINT16                    Speed; //0x15
  SMBIOS_TABLE_STRING       Manufacturer; //0x17
  SMBIOS_TABLE_STRING       SerialNumber; //0x18
  SMBIOS_TABLE_STRING       AssetTag; //0x19
