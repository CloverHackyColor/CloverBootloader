...
HDA_CONTROLLER_LIST_ENTRY gHdaControllerList[] = {
    ...
    { HDA_CONTROLLER(AMD, 0xaae0),  L"AMD Buffin HD Audio Controller" },
    { HDA_CONTROLLER(AMD, 0xaaf0),  L"AMD Ellesmere HD Audio Controller" },
...
VOID
EFIAPI
HdaControllerGetName(IN UINT32 ControllerID, OUT CHAR8 **Name)
{
  ...
  *Name = NULL;
  ...
  while (gHdaControllerList[ControllerIndex].Id != 0) {
    ...
    if (gHdaControllerList[ControllerIndex].Id == ControllerID) {
      *Name = gHdaControllerList[ControllerIndex].Name;
      break;
    }
    ControllerIndex++;
  }
...
VOID
EFIAPI
HdaCodecGetName(IN UINT32 CodecID, OUT CHAR8 **Name)
{
  UINTN CodecIndex = 0;
  ...
  *Name = NULL;
  ...
  while (gHdaCodecList[CodecIndex].Id != 0) {
    ...
    if ((gHdaCodecList[CodecIndex].Id == HdaCodecDev->VendorId) && (gHdaCodecList[CodecIndex].Rev <= ((UINT16)HdaCodecDev->RevisionId))) {
      *Name = gHdaCodecList[CodecIndex].Name;
      break;
    }
    CodecIndex++;
  }
