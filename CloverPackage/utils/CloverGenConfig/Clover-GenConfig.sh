#!/bin/sh
# clover-genconfig (Build Clover Slice config.plist)
# Vars
VERSION=1.0
cat > $HOME/config.plist <<EOF
...
<plist version="1.0">
    <dict>
        ...
        <dict>
            ...
            <dict>
                ...
                <array>
                    <dict>
                        <key>Arguments</key>
                        <string>initrd=\initramfs-linux.img root=/dev/sda6 rw add_efi_memmap</string>
                        <key>Path</key>
                    ...
                    <dict>
                        ...
                        <key>Path</key>
                        <string>\EFI\Gentoo\grub.efi</string>
                        <key>Title</key>
        ...
        <dict>
            ...
            <string>Apple Inc.</string>
            <key>BiosVersion</key>
            <string>IM131.88Z.F000.B00.1912181754</string>
            <key>Board-ID?</key>
            <string>Mac-FC02E91DDD3FA6A4</string>
            <key>BoardManufacturer</key>
            <string>Apple Inc.</string>
            <key>BoardSerialNumber</key>
            <string>C022295014NF2FRJC</string>
            <key>BoardType</key>
            <integer>10</integer>
            <key>BoardVersion</key>
            <string>1.0</string>
            ...
            <string></string>
            <key>SmUUID</key>
            <string>4F5991DC-A9CA-42E0-B4A4-C66CEE83A4FB</string>
            <key>Trust</key>
            <true/>
            <key>Version</key>
            <string>1.0</string>
        </dict>
        <key>SMBIOS_ventura</key>
        <dict>
            <key>BiosReleaseDate</key>
            <string>12/18/2019</string>
            <key>BiosVendor</key>
