...
cp -v $BUILD_DIR/IA32/OsxSmbiosDrv.efi $WORKSPACE/Clover/CloverPackage/CloverV2/drivers-Off/drivers32/OsxSmbiosDrv-32.efi
cp -v $BUILD_DIR/IA32/OsxFatBinaryDrv.efi $WORKSPACE/Clover/CloverPackage/CloverV2/drivers-Off/drivers32/OsxFatBinaryDrv-32.efi
...
echo Done!
cp -v $BUILD_DIR/X64/OsxSmbiosDrv.efi $WORKSPACE/Clover/CloverPackage/CloverV2/drivers-Off/drivers64/OsxSmbiosDrv-64.efi
cp -v $BUILD_DIR/X64/OsxFatBinaryDrv.efi $WORKSPACE/Clover/CloverPackage/CloverV2/drivers-Off/drivers64/OsxFatBinaryDrv-64.efi
fi
