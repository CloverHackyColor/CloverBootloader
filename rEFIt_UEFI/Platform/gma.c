...
//GT3e
    ...
    { 0x192B, "Intel Iris Graphics (Skylake GT3fe)" },
    { 0x192D, "Intel Iris Graphics P555" },
//GT4e
    //{ 0x1932, "Intel Skylake GT4" },
    //{ 0x193A, "Intel Skylake GT4" },
    { 0x193B, "Intel Iris Graphics P580" },
    { 0x193D, "Intel Iris Graphics P580" },
