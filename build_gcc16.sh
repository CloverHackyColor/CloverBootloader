...
# 
export BINUTILS_VERSION=${BINUTILS_VERSION:-binutils-2.46.1} #2.42
export GCC_VERSION=${GCC_VERSION:-16.1.0}
...
#        curl -k -f -o download.tmp --remote-name https://sourceware.org/pub/gcc/releases/gcc-${GCC_VERSION}/gcc-${GCC_VERSION}.tar.xz || exit 1
        curl -k -f -o download.tmp --remote-name https://ftp.fu-berlin.de/unix/languages/gcc/releases/gcc-16.1.0/gcc-16.1.0.tar.xz || exit 1
